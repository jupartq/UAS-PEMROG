...
def fungsi_percabangan (var_nilai) :
    var_huruf = ""
    if (var_nilai >= 0 and var_nilai < 10) : var_huruf = "E" 
    elif (var_nilai >= 10 and var_nilai < 20) : var_huruf = "D" 
    elif (var_nilai >= 20 and var_nilai < 30) : var_huruf = "C" 
    elif (var_nilai >= 30 and var_nilai < 40) : var_huruf = "B" 
    elif (var_nilai >= 40 and var_nilai <= 50) : var_huruf = "A"
    return var_huruf
